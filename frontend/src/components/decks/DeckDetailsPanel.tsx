...
export default function DeckDetailsPanel({ deck, onClose }: DeckDetailsPanelProps) {
  ...
  // Temporary random cards (you can replace this with real data later)
  const randomCards = [
    { name: "Voidling", quantity: 3 },
    { name: "Empress's Guard", quantity: 2 },
    { name: "Adaptive Carapace", quantity: 1 },
    { name: "Kaisa's Wrath", quantity: 3 },
    { name: "Radiant Strike", quantity: 2 },
    { name: "Celestial Blessing", quantity: 1 },
  ];
